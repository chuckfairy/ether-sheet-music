...
var Provider = /** @class */ (function () {
    ...
    Provider.prototype.dequeue = function () {
        ...
        var _a = this.queue.shift(), payload = _a.payload, cb = _a.cb;
        this.sendPostMessage(exports.postMessages.PT_HANDLE_REQUEST, payload);
        ...
        window.addEventListener('message', function (evt) {
            if (evt.origin === _this.referrerAppOptions.portisLocation) {
                switch (evt.data.msgType) {
                    ...
                    case exports.postMessages.PT_SHOW_IFRAME: {
                        _this.showIframe();
                        break;
                    }
                    case exports.postMessages.PT_HIDE_IFRAME: {
                        _this.hideIframe();
                        break;
                    }
